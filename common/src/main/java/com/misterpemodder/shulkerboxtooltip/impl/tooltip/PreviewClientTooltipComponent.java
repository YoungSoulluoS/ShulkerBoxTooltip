...
public class PreviewClientTooltipComponent extends PositionAwareClientTooltipComponent {
  ...
  @Override
  public void renderImageWithTooltipPosition(Font font, int x, int y, GuiGraphics graphics, int tooltipTopY,
  ...
  private void drawAt(int x, int y, GuiGraphics graphics, Font font, int mouseX, int mouseY) {
    ...
    if (screen != null) {
      this.renderer.draw(x, y, graphics.getZ(), graphics.getPoseStack(), font, graphics.getItemRenderer(),
